...
class GameOverScreen extends Dialog {
    ...
    factory GameOverScreen(UIInterface ui, String reason) {
        ...
        GameOverScreen screen = new GameOverScreen._internal(ui, contents);
        screen.addButton(new Button(ui, "Try again?", () {
            screen.close(null);
        }));
    ...
    GameOverScreen._internal(UIInterface ui, View contents) : super(ui, contents
            );
}
