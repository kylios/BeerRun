...
class LevelRequirementsScreen extends Dialog {
    ...
    factory LevelRequirementsScreen(UIInterface ui, String name, int
            beers, Duration duration) {
        ...
        LevelRequirementsScreen screen = new LevelRequirementsScreen._internal(
                ui, contents);
        screen.addButton(new Button(ui, "Start!", () {
            screen.close(null);
        }));
   ...
   */
    LevelRequirementsScreen._internal(UIInterface ui, View contents) : super(ui,
            contents);
}
