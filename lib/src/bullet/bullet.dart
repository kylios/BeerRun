...
class Bullet extends GameObject {
    ...
    Bullet(Level l, this._creator, Direction d, int x, int y, Component
            c, DrawingComponent drw) : super(d, x, y) {
        this.setLevel(l);
        ...
        SpriteSheet sprites = new SpriteSheet("img/Muzzleflashes-Shots.png", 32,
                32);
