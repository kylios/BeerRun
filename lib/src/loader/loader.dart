...
class Loader {
    ...
    Loader(this._host) : this._futures = new List<Future<Resource>>();
    ...
    Future<Resource> load(Resource resource) {
        ...
        HttpRequest.request(this._getUrlString(resource.uri), method:
                resource.method, responseType: resource.responseType, requestHeaders:
                resource.requestHeaders).then((HttpRequest request) {
        ...
        }, test: (e) => e is FormatException).catchError((var request) {
