...
class ControlsScreen extends TutorialDialog {
    ...
    ControlsScreen(UIInterface ui, Tutorial tutorial) : super(ui, tutorial, "",
            null);
    ...
    void _init(UIInterface ui) {
        ...
        ImageView klView = new ImageView.fromSrc(ui,
                "assets/ui/keyboard/Keyboard_White_Arrow_Left.png", 24, 24);
        ImageView krView = new ImageView.fromSrc(ui,
                "assets/ui/keyboard/Keyboard_White_Arrow_Right.png", 24, 24);
        ImageView kuView = new ImageView.fromSrc(ui,
                "assets/ui/keyboard/Keyboard_White_Arrow_Up.png", 24, 24);
        ImageView kdView = new ImageView.fromSrc(ui,
                "assets/ui/keyboard/Keyboard_White_Arrow_Down.png", 24, 24);
        ClearView kcView = new ClearView(ui);
        TextView movementOrView = new TextView(ui, " OR ");
        movementOrView.evaluateVars();
        ImageView aView = new ImageView.fromSrc(ui,
                "assets/ui/keyboard/Keyboard_White_A.png", 24, 24);
        ImageView sView = new ImageView.fromSrc(ui,
                "assets/ui/keyboard/Keyboard_White_S.png", 24, 24);
        ImageView dView = new ImageView.fromSrc(ui,
                "assets/ui/keyboard/Keyboard_White_D.png", 24, 24);
        ImageView wView = new ImageView.fromSrc(ui,
                "assets/ui/keyboard/Keyboard_White_W.png", 24, 24);
        ...
        ImageView pView = new ImageView.fromSrc(ui,
                "assets/ui/keyboard/Keyboard_White_P.png", 24, 24);
