...
class CarGeneratorComponent extends Component {
    ...
    void update(CarFactory factory) {
        ...
        if (this._spawnCount >= this._spawnAt) {
            ...
            Car c = new Car(this._path, DIR_UP, blah, factory.vert,
                    factory.horiz);
            c.setLevel(factory.level);
            c.setDrawingComponent(new DrawingComponent(
                    factory.level.canvasManager, factory.level.canvasDrawer, false));
