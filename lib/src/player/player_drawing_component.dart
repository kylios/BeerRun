...
class PlayerDrawingComponent extends DrawingComponent {
    ...
    PlayerDrawingComponent(CanvasManager manager, CanvasDrawer drawer, bool
            scrollBackground) : super(manager, drawer, scrollBackground) {
        ...
        SpriteSheet beerSprites = new SpriteSheet(
                "assets/sprites/player/beer.png", 64, 64);
    ...
    void update(Player obj) {
        ...
        if (this.scrollBackground) {
            this.drawer.setOffset(obj.x + obj.tileWidth - (this.manager.width ~/
                    2), obj.y + obj.tileHeight - (this.manager.height ~/ 2));
        }
        ...
        if (obj.beers > 0) {
            this.drawer.drawSprite(this._beerSprites[obj.dir.direction], obj.x,
                    obj.y, obj.tileWidth, obj.tileHeight);
        }
