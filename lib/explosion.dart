...
class Explosion extends GraphicAnimation {
    ...
    factory Explosion.createAt(int x, int y, int width, int height) {
        ...
        List<Sprite> sprites = [sheet.spriteAtNew(0, 0), sheet.spriteAtNew(0, 1
                ), sheet.spriteAtNew(0, 2), sheet.spriteAtNew(0, 3), sheet.spriteAtNew(1, 0),
                sheet.spriteAtNew(1, 1), sheet.spriteAtNew(1, 2), sheet.spriteAtNew(1, 3),
                sheet.spriteAtNew(2, 0), sheet.spriteAtNew(2, 1), sheet.spriteAtNew(2, 2),
                sheet.spriteAtNew(2, 3), sheet.spriteAtNew(3, 0), sheet.spriteAtNew(3, 1),
                sheet.spriteAtNew(3, 2), sheet.spriteAtNew(3, 3)];
